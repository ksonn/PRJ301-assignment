...
public class ListAppointment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Appointment> listAppointment = db.getListAppointment();
        request.setAttribute("listAppointment", listAppointment);
        request.getRequestDispatcher("view/clinic/appointment/listappointment.jsp").forward(request, response);
    }
